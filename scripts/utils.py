...
def create_equally_spaced_angles( nang , angle_start , angle_end ):
    spacing = ( angle_end - angle_start ) / myfloat( nang )
    angles = np.arange( angle_start , angle_end , spacing ).astype( myfloat )
    return angles  
...
def create_projection_angles( nang=None , pseudo=0 , start=0.0 , end=180.0 , 
                              wedge=False , textfile=None ):
