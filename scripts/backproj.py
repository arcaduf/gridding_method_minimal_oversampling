...
#################################################################################
#######                                                                   #######
#######                 TOMOGRAPHIC GRIDDING RECONSTRUCTION               #######
#######                                                                   #######
...
def getArgs():
    parser = argparse.ArgumentParser(description='Tomographic gridding reconstruction',
    ...
    parser.add_argument('-z', dest='oversampl', type=myfloat, default=1.25,
                        help='Specify zero padding as fraction of the number of \
                             the pixels in the sinogram') 
    
    parser.add_argument('-c', dest='ctr', type=myfloat, default=0.0,
