...
#################################################################################
#######                                                                   #######
#######               TOMOGRAPHIC GRIDDING FORWARD PROJECTION             #######
#######                                                                   #######
...
def getArgs():
    parser = argparse.ArgumentParser(description='Tomographic gridding forward projection',
    ...
    parser.add_argument('-g', dest='geometry', default='0',
                        help='Specify projection geometry;'
                             ...
                             +' 180 degrees (default);'
                             +' -g angles.txt use a list of angles'
...
def main():
    ...
    print('\n')
    print('####################################################################')
    print('############   TOMOGRAPHIC GRIDDING FORWARD PROJECTION  ############')
    print('####################################################################')
    print('\n')
    ...
    if args.geometry == '0' or args.geometry == '1':
        ...
        angles = utils.create_projection_angles( nang , angle_type , 
    ...
    print('\n')
    print('################################################')
    print('####    GRIDDING FORWARD PROJECTION DONE !  ####')
    print('################################################')
    print('\n')
