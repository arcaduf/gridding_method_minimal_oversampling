...
sys.path.append( '../gridding_module/pymodule_gridrec_v4/' )
import gridding_lut as glut
...
class projectors:
    ...
    def __init__( self , npix , angles , ctr=0.0 , kernel='kb' ,
                  oversampl=1.25 , interp='lin' , radon_degree=0 , 
                  W=7.0 , errs=1e-3 , filt=None , args=None ):  
